...
public class Init {
	...
	public static void deleteUser() {
		try {
			...
			String sql = "drop user c##toilet cascade";
	...
	public static void createTable() {
		String[] sqlStatements = {
			...
			try {
				Connection conn = ConnectionProvider.getConnection("c##toilet", "toilet");
	            Statement stmt = conn.createStatement();
	...
	public static void insertToiletDataFromCSV(String csvPath) {
